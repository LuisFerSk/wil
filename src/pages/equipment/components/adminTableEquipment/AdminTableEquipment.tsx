...
interface Props extends TableDataInterface<EquipmentInterface> {
    updateProps: BrandStateInterface
}

export default function AdminTableEquipment(props: Props) {
    const EquipmentView = lazy(() => import('../viewEquipment/ViewEquipment'))
    const EquipmentDelete = lazy(() => import('../deleteEquipment/DeleteEquipment'))
    const EquipmentUpdate = lazy(() => import('../updateEquipment/UpdateEquipment'))
