...
export default function PrinterScannerTable(props: Props) {
    const PrinterScannerView = lazy(() => import('../viewPrinterScanner/ViewPrinterScanner'))
    const PrinterScannerDelete = lazy(() => import('../deletePrinterScanner/DeletePrinterScanner'))
    const PrinterScannerUpdate = lazy(() => import('../updatePrinterScanner/UpdatePrinterScanner'))
