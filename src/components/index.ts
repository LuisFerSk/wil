...
export { default as AutocompleteBrand } from './autocompleteBrand/AutocompleteBrand';
...
export { default as FormEquipment } from './formEquipment/FormEquipment';
export { default as FormPrinterScanner } from './formPrinterScanner/FormPrinterScanner';
