...
import { CustomShadowsInterface } from 'interfaces'

import palette from './palette'

const color = palette.grey[500]

function createShadow(): Shadows {
...
function createCustomShadow(): CustomShadowsInterface {
...
export const customShadows = createCustomShadow()
